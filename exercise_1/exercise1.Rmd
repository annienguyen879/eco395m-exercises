...
```{r 95 percentile atheltics, echo=FALSE, message=FALSE, results=FALSE}
library(tidyverse)
...
```{r women sd height, echo=FALSE, message=FALSE}
...
```{r Olympic swimmers graph, warning=FALSE, echo=FALSE, message='false'}

...
```
  ...
  2. Basic CART model with average temperature
```{r Avg Temp CART}
# CART Model
...
```
  ...
  3. Basic CART model with dew point temmperature 
```{r Dew Point CART}
# CART Model
...
```
  ...
  4. Basic CART Model with average temperature and dew point
...
```
  ...
  2. Basic Random Forests with average temperature
...
```
  ...
  3. Basic Random Forests with dew point 
...
```
  ...
  4. Basic Random Forests with average temperature and dew point
...
```
  ...
  2. Basic Gradient-Boosted Trees with average temperature
...
```
  ...
  3. Basic Gradient-Boosted Trees with dew point
...
```
  ...
  4. Basic Gradient-Boosted Trees with average temperature and dew point

...
```{r K value, echo=FALSE, warning=FALSE}
##  1. Clustering and PCA
...
```{r K Means Clusters, echo=FALSE, warning=FALSE}
...
```{r K Means feature plots, echo=FALSE, warning=FALSE}
...
```{r K means distinguishing high quality wine plots, echo=FALSE, warning=FALSE}
